...
def siapa():
	...
	if nama =="":
		print"\033[1;96m[!] \033[1;91mIsi yang benar su_-"
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
...
def loginSC():
	os.system('clear')
	print"\033[1;97mSilahkan login SC nya dulu Njing!_<\n"
	username = raw_input("\033[1;96m[*] \033[1;97mUsername \033[1;91m: \033[1;92m")
	password = raw_input("\033[1;96m[*] \033[1;97mPassword \033[1;91m: \033[1;92m")
	if username =="ID" and password =="FB":
		print"\033[1;96m[✓] \033[1;92mLogin success"
		time.sleep(1)
		login()
	else:
		print"\033[1;96m[!] \033[1;91mSalah Goblok!!-_-"
		time.sleep(1)
                LoginSC()
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCVaKVhhcdngVG1aGjzDLFmg')
				menu()
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email salah Goblok!_-")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def pilih():
	...
	if unikers =="":
		print "\033[1;96m[!] \x1b[1;91mIsi yang benar bngsd_-"
		pilih()
	elif unikers =="1":
		super()
	elif unikers =="2":
